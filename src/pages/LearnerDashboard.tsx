            ...
            <header className="group relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-indigo-900/30 via-slate-900/60 to-[#0b0c0f] p-8 sm:p-12 hover-lift hover-glow shadow-2xl animate-rise">
              ...
              <div className="relative z-10 flex flex-col gap-8 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div className="flex items-center gap-3">
                  <button type="button" onClick={() => void fetchData()} className="btn-secondary px-3 py-2" title="Refresh">
                    <RefreshCcw className="h-4 w-4" />
                  </button>
                  <button type="button" onClick={handleSignOut} className="btn-secondary text-[var(--danger-text)]">
                ...
                <>
                  ...
                  {assessmentPages > 1 && (
                    <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                      ...
                      <button type="button" className="btn-primary" disabled={assessmentPage >= assessmentPages} onClick={() => setAssessmentPage(p => Math.min(assessmentPages, p + 1))}>
                        Next
                      </button>
                    </div>
                  )}
                ...
                <>
                  ...
                  {resultsPages > 1 && (
                    <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                      ...
                      <button type="button" className="btn-primary" disabled={resultsPage >= resultsPages} onClick={() => setResultsPage(p => Math.min(resultsPages, p + 1))}>
                        Next
                      </button>
                    </div>
                  )}
